 ...
 */
@WebServlet(name = "RepoDenuServ", urlPatterns = {"/RepoDenuServ"})
public class RepoDenuServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     String salida;
        ...
        try
        {
            ...
            Map parametros =null;
            String reporte ="repoDenu.jasper";
            byte[] bytes = null;
            ...
            try {
                ...
                response.setHeader("Content-Disposition", "inline; filename=Denuncias.pdf");
