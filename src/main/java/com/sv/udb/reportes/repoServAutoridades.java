 ...
 * @author Jose Lira
 */
@WebServlet(name = "repoServAutoridades", urlPatterns = {"/repoServAutoridades"})
public class repoServAutoridades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String reporte = "ReporteAutoridad.jasper";
